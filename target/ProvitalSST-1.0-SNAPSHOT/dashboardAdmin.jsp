...
<body>
    <div class="layout-admin">
        ...
        <div class="contenido-admin">
            ...
            <div class="container-fluid p-4">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0"><i class="bi bi-bell-fill" style="color: var(--verde-boton);"></i> Alertas</h5>
                        </div>
                ...
                <h5 class="mb-3"><i class="bi bi-grid-fill" style="color: var(--verde-principal);"></i> Menú</h5>
                <div class="row g-4">
                    <div class="col-md-4">
    ...
    <style>
        .alerta-card { border-radius: 12px; background: white; overflow: hidden; height: 100%; }
        ...
        .ver-detalles { font-weight: 600; font-size: 14px; text-decoration: none; }
        ...
        .menu-item { display: flex; align-items: center; gap: 15px; padding: 16px 20px; text-decoration: none; color: #172B3A; border-bottom: 1px solid #f0f0f0; }
